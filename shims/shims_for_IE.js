...
// work around https://github.com/angular/angular/issues/#6501. To be re-evaluated
// once that issue is closed.

// function.name (all IE)
/*! @source http://stackoverflow.com/questions/6903762/function-name-not-supported-in-ie*/
/*! @source https://github.com/justindujardin/angular/commit/1fdb099a3509503a6c644744957a7ba3c5c46a0b*/
if (!Object.hasOwnProperty('name')) {
  Object.defineProperty(Function.prototype, 'name', {
    get: function() {
      var matches = this.toString().match(/^\s*function\s*([a-zA-z\_\$]*)\s*\(/)
